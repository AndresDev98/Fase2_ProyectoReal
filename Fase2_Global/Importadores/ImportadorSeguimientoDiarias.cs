...
{
    public class ImportadorSeguimientoDiarias : Importador
    {
        public ImportadorSeguimientoDiarias(ILogger<Importador> logger) : base(logger)
        {
        }
        ...
        protected override string GetFicheroTipo() => "Seguimiento";
        ...
        protected override string GetTableName() => "IN_SEGUIMIENTO";
        protected override string GetTableName2() => "";

        public void ExecuteSeguimientoDiarias(Database database, string fullName, DateTime fechaFichero, bool Transaction = false)
        {
