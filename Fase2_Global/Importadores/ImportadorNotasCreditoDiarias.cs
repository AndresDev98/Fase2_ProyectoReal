...
{
    public class ImportadorNotasCreditoDiarias : Importador
    {
        public ImportadorNotasCreditoDiarias(ILogger<Importador> logger) : base(logger)
        {
        }

        protected override char GetDelimited() => ';';

        protected override int GetFicheroTipoId() => 27;

        protected override string GetFicheroTipo() => "Notas Crédito";
        ...
        protected override string GetTableName() => "IN_NOTA_CREDITO";
        protected override string GetTableName2() => "";

        public void ExecuteNotasCreditoDiarias(Database database, string fullName, DateTime fechaFichero, bool Transaction = false)
        {
