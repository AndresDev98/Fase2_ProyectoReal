...
{
    public class ImportadorFacturacionAgrupadaSemanalB2B : Importador
    {
        public ImportadorFacturacionAgrupadaSemanalB2B(ILogger<Importador> logger) : base(logger)
        {
        }

        protected override char GetDelimited() => ';';

        protected override int GetFicheroTipoId() => 25;

        protected override string GetFicheroTipo() => "Facturas Agrupadas B2B";
        ...
        protected override string GetTableName() => "IN_FACTURACION_AGRUPADA_B2B";
        protected override string GetTableName2() => "IN_FACTURACION_AGRUPADA_PERIODOS_B2B";

        public void ExecuteFacturacionAgrupadaSemanalB2B(Database database, string fullName, DateTime fechaFichero, bool Transaction = false)
        {
                                                ...
                                                try
                                                {
                                                    ...
                                                    switch (datatableAgrupacionPeriodos.Columns[i].ColumnName)
                                                    {
                                                        ...
                                                        case "idCommodityCostumer":
                                                            ...
                                                            break;
                                                        case "idSegmento":
                                                            valueAgrupacionPeriodos = "1";//Constante
                                                            break;
