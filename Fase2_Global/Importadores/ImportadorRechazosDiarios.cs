...
{
    public class ImportadorRechazosDiarios : Importador
    {
        public ImportadorRechazosDiarios(ILogger<Importador> logger) : base(logger)
        {
        }

        protected override char GetDelimited() => ';';

        protected override int GetFicheroTipoId() => 5;

        protected override string GetFicheroTipo() => "Rechazos B2C";
        ...
        protected override string GetTableName() => "IN_RECHAZOS_B2C";
        protected override string GetTableName2() => "STG_RECHAZOS_HISTORICO";

        public List<string> ExecuteRechazosDiarios(Database database, string fullName, DateTime fechaFichero, bool Transaction = false)
        {
