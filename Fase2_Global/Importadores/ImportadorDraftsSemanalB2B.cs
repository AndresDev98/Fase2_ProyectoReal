...
{
    public class ImportadorDraftsSemanalB2B : Importador
    {
        public ImportadorDraftsSemanalB2B(ILogger<Importador> logger) : base(logger)
        {
        }

        protected override char GetDelimited() => ';';

        protected override int GetFicheroTipoId() => 26;
        ...
        protected override string GetTableName() => "IN_DRAFTS_B2B";
        protected override string GetTableName2() => "IN_DRAFTS_VALIDATIONERROR";

        public void ExecuteDraftsSemanalB2B(Database database, string fullName, DateTime fechaFichero, bool Transaction = false)
        {
                                        ...
                                        try
                                        {
                                            ...
                                            switch (datatableValidationError.Columns[i].ColumnName)
                                            {
                                                ...
                                                case "Account ID":
                                                    ...
                                                    break;
                                                case "idSegmento":
                                                    valueValidationError = "1";//Constante
                                                    break;
                                                case "idInvoiceStatus":
                                                    ...
                                                    case "System.Decimal":
                                                        {
                                                            ...
                                                            if (valueValidationError.Split(',').Count() > 2)
                                                            {
                                                                var regex = new Regex(Regex.Escape(","));
