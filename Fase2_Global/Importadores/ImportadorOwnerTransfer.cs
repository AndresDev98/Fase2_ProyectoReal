...
{
    public class ImportadorOwnerTransfer : Importador
    {
        public ImportadorOwnerTransfer(ILogger<Importador> logger) : base(logger)
        {
        }
        ...
        protected override string GetFicheroTipo() => "Owner Transfer";

        protected override string GetHeader() => "Suscripción: Nombre;Cuenta: Número de cuenta;Modificación de la versión de suscripción: Nombre;Modificación de la versión de suscripción: Fecha efectiva;Modificación de la versión de suscripción: Fecha de creación";

        protected override string GetTableName() => "IN_OWNER_TRANSFET";

        protected override string GetTableName2() => "";

        private Dictionary<string, Dictionary<string, int>> MasterKey;

        public void ExecuteOwnerTransfer(Database database, string fullName, DateTime fechaFichero, bool Transaction = false)
        {
